...
/// @title NFT positions
/// @notice Wraps Secta V3 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    ) ERC721Permit('Secta V3 Positions NFT-V1', 'PCS-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
