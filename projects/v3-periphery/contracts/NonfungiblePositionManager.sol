...
/// @title NFT positions
/// @notice Wraps Secta Dex positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    ) ERC721Permit('Secta Dex Positions NFT-V1', 'SD-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
