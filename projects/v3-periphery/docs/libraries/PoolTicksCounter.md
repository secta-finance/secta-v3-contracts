...
```solidity
function countInitializedTicksCrossed(contract ISectaDexPool self, int24 tickBefore, int24 tickAfter) internal view returns (uint32 initializedTicksCrossed)
```
