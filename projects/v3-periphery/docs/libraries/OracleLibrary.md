...
Calculates time-weighted means of tick and liquidity for a given SectaFi Dex pool
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | address | Address of SectaFi Dex pool that we want to observe |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | address | Address of SectaFi Dex pool |
