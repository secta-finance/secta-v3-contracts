...
import './interfaces/ISectaDexFactory.sol';
...
contract SectaDexPool is ISectaDexPool {
    ...
    /// @inheritdoc ISectaDexPoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == ISectaDexFactory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ISectaDexPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc ISectaDexPoolDerivedState
    ...
    /// @inheritdoc ISectaDexPoolActions
    ...
    function mint(
        ...
        ISectaDexMintCallback(msg.sender).sectaDexMintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ISectaDexSwapCallback(msg.sender).sectaDexSwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        ISectaDexFlashCallback(msg.sender).sectaDexFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc ISectaDexPoolOwnerActions
