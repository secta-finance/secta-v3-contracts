...
describe('SectaDexPool', () => {
  ...
  let pool0: MockTimeSectaDexPool
  let pool1: MockTimeSectaDexPool
  ...
  let swapTargetCallee: TestSectaDexCallee
  let swapTargetRouter: TestSectaDexRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeSectaDexPool, any]> => {
