...
contract MasterChefV3 is INonfungiblePositionManagerStruct, Multicall, Ownable, ReentrancyGuard, Enumerable {
    ...
    event AddPool(uint256 indexed pid, uint256 allocPoint, ISectaDexPool indexed v3Pool, ILMPool indexed lmPool);
    ...
    function add(uint256 _allocPoint, ISectaDexPool _v3Pool, bool _withUpdate) external onlyOwner {
    ...
    function onERC721Received(
        ...
        if (msg.sender != address(nonfungiblePositionManager)) revert NotSectaNFT();
