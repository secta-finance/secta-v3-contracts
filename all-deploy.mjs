...
await $`yarn workspace @sectafi/masterchef-v3 run hardhat run scripts/deploy2.ts --network ${network}`

await $`yarn workspace @sectafi/v3-lm-pool run hardhat run scripts/deploy2.ts --network ${network}`
